...
const AccountSettings: React.FC<AccountSettingsProps> = ({ onClose,onBillingClick }) => {
  ...
  return (
    <>
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center overflow-auto">
      <div className="w-[811px] max-h-[95vh] overflow-y-auto bg-white rounded-[15px] p-6 relative">
        <button
          onClick={onClose}
        ...
        <div className="space-y-4 mt-[30px]">
          ...
          <div className="flex items-center justify-between">
           ...
           {logo &&
                <div className="relative w-[96px] h-[92px] border bg-[#DCEEFF] flex justify-end ml-[290px]">
                  <img
                    src={logo}
                    alt="Business Logo"
          ...
          <div className="flex items-center gap-[230px]">
            ...
            <button className="text-[#000000B0] font-[500] text-[14px] w-[149px] h-[43px] border border-[#ECEEF1] rounded-[10px] bg-[#F3F4F6] cursor-pointer"
...
// Billing Info Modal
    {showBillingInfo && (<BillingInformation onClose={()=> setShowBillingInfo(false)}/>)}
    </>
